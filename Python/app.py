from flask import Flask, render_template, request, redirect # Flask is a webserver that runs python?
...
# "with" is a way to open and close a file in python without having to explicitly calling the open and close.